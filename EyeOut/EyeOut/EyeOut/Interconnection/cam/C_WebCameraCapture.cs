...
namespace EyeOut
{
    public class C_WebCameraCaptureData
    {
        //cv::Mat image;
        BitmapSource image;
        //OVR.posef pose;
        public C_WebCameraCaptureData(BitmapSource _image)
        {
            image = _image;
        }
    ...
    public class C_WebCameraCaptureHandler
    {
        // instance of class interacting with camera
        private C_WebCamera cam;  // resp in fact I can use Capture & all the conversion would be defined here..
        //private Capture capture;        //takes images from camera as image frames
        //public static int actualId;

        private C_WebCameraCaptureData captureData;
        ...
        public C_WebCameraCaptureHandler(SharpOVR.HMD _hmd, int _camId)
        {
            // open the camera and set it up
            cam = new C_WebCamera(_camId);
            hmd = _hmd;
            isStopped = true;
        }
        ...
        // with a locker
        public C_WebCameraCaptureData CaptureData // nullable
        {
            get
            {
        ...
        {
            C_Logger.Instance.LOG_err(e_LogMsgSource.cam_err, _msg);
        }
        //%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        #endregion LOG
        //%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
