...
namespace EyeOut
{
    ...
    public class C_WebCamera
    {
        ...
        public C_WebCamera(int _id)
        {
            id = _id;
            INIT_capture();
        }

        public C_WebCamera(int _id, double _camLatency)
        {
            id = _id;
        ...
        public void INIT_capture()
        {
            ...
            catch (NullReferenceException excpt)
            {
                ...
                {
                    LOG_err("Catched exception when creating camera capture: " + ex.Message);
                }
            }
        }
